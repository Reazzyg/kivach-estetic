 ...
 <body>
   ...
   <!-- /.header -->
   <main></main>
<h1 class="subtitle">ИП Воробьев Р.В.</h1>

<img src="/assets/img/doctors/conf_1.jpg" alt="">

<ul class="info-list"><li class="info-list__item">фыфыфывфывфыв</li><li class="info-list__item">фыв</li><li class="info-list__item">фыв</li><li class="info-list__item">фыв</li><li class="info-list__item">фыв</li><li class="info-list__item">фы</li><li class="info-list__item">вфы</li><li class="info-list__item">вфы</li><li class="info-list__item">фы</li><li class="info-list__item">в</li></ul>
  </main>
  <footer class="footer">
