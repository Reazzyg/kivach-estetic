 ...
 <head>
   ...
   <title>
     Александр Олегович ЗАЙЦЕВ     &mdash;
...
<section class="info reverse info-doctor">
  <h2 class="subtitle">Александр Олегович ЗАЙЦЕВ</h2>
  <div class="container">
    <div class="info-wrapper">
      <ul class="info-list"><li class="info-list__item">Окончил Петрозаводский госуниверситет и ординатуру при нём по специальности «Пластическая и реконструктивная хирургия».</li><li class="info-list__item">Стажировался в BK HOSPITAL, г.Сеул, Южная Корея.</li><li class="info-list__item">Постоянно принимает участие в международных симпозиумах и мастер-классах по пластической и реконструктивной хирургии.</li></ul>    </div>
    <img src="/assets/img/doctors/spec1.jpg" alt="" class="info__img info-doctor__img brs30 ">
  </div>
</section>
