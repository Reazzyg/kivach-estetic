...
<section class="info reverse info-doctor">
  ...
  <div class="container">
    <div class="info-wrapper">
      <ul class="info-list"><li class="info-list__item">asd</li><li class="info-list__item">as</li><li class="info-list__item">das</li></ul>    </div>
    <img src="/assets/img/doctors/улич рбк.jpg" alt="" class="info__img info-doctor__img brs30 ">
  </div>
</section>
