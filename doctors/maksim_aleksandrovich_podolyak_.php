 ...
 <head>
   ...
   <title>
     Максим Александрович ПОДОЛЯК      &mdash;
     Кивач Эстетик Плюс   </title>
 </head>

 <body>
   <header class="header">
     <div class="container header-container">
       <a href="/"> <img src="/assets/img/logo.png" alt="лого Кивач Эстетик Плюс" class="logo header-logo"></a>
       ...
       <div class="social header-social">
         <img src="/assets/img/Phone.svg" alt="phone icon" class="header-social__icon">
...
<section class="info reverse info-doctor">
  <h2 class="subtitle">Максим Александрович ПОДОЛЯК </h2>
  <div class="container">
    <div class="info-wrapper">
      <ul class="info-list"><li class="info-list__item">Окончил Петрозаводский госуниверситет и интернатуру при нём по специальности «Хирургия»</li><li class="info-list__item">Прошёл профессиональную переподготовку по специальности «Онкология»</li><li class="info-list__item">Более 10-ти лет проработал в онко-хирургии, из которых 7 лет занимался непосредственно реконструктивно-пластической хирургией головы и шеи</li><li class="info-list__item">В год производит 250 операций</li><li class="info-list__item">Всего с начала карьеры произвёл более 3000 операций</li></ul>    </div>
    <img src="/assets/img/doctors/podolyak.jpg" alt="" class="info__img info-doctor__img brs30 ">
  </div>
</section>
      ...
      <div class="footer-wrap">
        ...
        <div class="footer-wrapper">
          ...
          <div class="footer-wrapper desktop">
            <div class="footer-wrap">
              <img src="/assets/img/efqm.png" alt="" class="footer__img">
            ...
            <!-- /.footer-wrap -->
            <div class="footer-wrap">
              <img src="/assets/img/coin.jpg" alt="" class="footer__img">
              <p class="footer__text">Cерия универсальных стандартов, разработанных американской компанией Joint
                ...
                данном медицинском учреждении.</p>
            </div>
            <!-- /.footer-wrap -->
          </div>
          <!-- /.footer-wrapper -->
