...
<section class="info">
  <h2 class="subtitle">HD-Lipo</h2>
  <div class="container">
    <div class="info-wrapper">
      <p class="text info__text">Это передовой метод липосакции, основанный на технологии PAL Lipo. Позволяет добиться
        идеального контурирования очертаний тела для достижения скульптурных форм.</p>
      <p class="text info__text">Это передовой метод липосакции, основанный на технологии PAL Lipo. Позволяет добиться
        идеального контурирования очертаний тела для достижения скульптурных форм.</p>
      <p class="text info__text">В процедуре используется система PAL, которая минимизирует синяки и отеки, что приводит
        к более быстрому восстановлению.</p>
      <p class="text info__text">Подходит для женщин и мужчин, стремящихся к идеальному телосложению.</p>
      <a href="/plastic-surgery/liposuction/">PAL Lipo – подробнее здесь. </a>
    </div>
  ...
  <div class="container">
    <div class="info-wrapper">
      <p class="text info__text">Технология PAL Lipo добавляет к движению канюли лёгкую вибрацию, обеспечивая
        максимальную селективность в отношении жировых клеток. Процедура приобретает новое изящество и предоставляет
        хирургу улучшенный контроль. Это наилучшее решение, когда требуется сверхточность для скульптурного
        моделирования фигуры.</p>
    </div>
    <img src="<? get_img_path() ?>rino-text-1.png" alt="фото коррекции формы носа" class="info__img brs30 ">
  </div>
</section>
...
<section class="info reverse">
  <h2 class="subtitle">Комбинируя для достижения наилучшего результата</h2>
  <div class="container">
    <div class="info-wrapper">
      <p class="text info__text">В ходе процедуры удаляется небольшой объём жира, что позволяет обнажить естественные
        контуры мышц. Для достижения максимального результата в некоторых случаях рекомендуется комбинировать HD Lipo с
        аппаратной (не хирургической) подтяжкой кожи.</p>
    </div>
    <img src="<? get_img_path() ?>rino-text-1.png" alt="фото коррекции формы носа" class="info__img brs30 ">
  </div>
</section>
...
<section class="page bg">
  <div class="container">
    ...
    <p class="text">Воспользуйтесь специализированной техникой липосакции, позволяющей контурировать мышцы живота,
      придав им модельный вид.</p>
    <p class="text">Офорт абдоминальной мускулатуры – одна из самых популярных процедур пластической хирургии для тех,
      кто стремится к идеалу. Это продвинутая форма липосакции, при которой избирательно удаляются небольшие количества
      жира из области живота, чтобы подчеркнуть естественный рельеф мышц пресса.</p>
    <p class="text">Процедура включает в себя использование специальных хирургических инструментов для удаления жира и
      выделения подлежащей мускулатуры.</p>
...
<section class="info center">
  <h2 class="subtitle">Избавьтесь от досадных нюансов. Воспользуйтесь HD Lipo, чтобы превратить своё тело в идеал.</h2>
  <div class="container">
    <div class="info-wrapper">
  ...
  <div class="container">
    <ul class="info-list info-list-order">
      <li class="info-list__item">
        ...
        Запишитесь на первичную консультацию, чтобы узнать, как с помощью HD Lipo привести ваше тело к идеальным
        представлениям. Врач проведёт осмотр, назначит исследования (если они необходимы) и согласует с вами дату
        операции.
      </li>
      <li class="info-list__item">
